...
def draw(self, screen):
    # GoodItem: gambar lingkaran hijau
    # BadItem: gambar lingkaran merah dengan X
...
### Aturan
1. Tangkap makanan segar (hijau) untuk mendapat +5 poin
2. Hindari makanan busuk (merah) yang mengurangi -1 HP
...
```bash
# Pastikan menjalankan dari direktori yang benar
cd "d:/BELAJAR_PYTHON/GAME CAK"
python src/main.py
```
...
Game ini mendemonstrasikan:
- ✅ Object-Oriented Programming (OOP)
- ✅ Game development dengan Pygame
- ✅ Audio programming dengan procedural sound generation
- ✅ State management dan screen transitions
- ✅ Particle systems dan visual effects
- ✅ Collision detection
- ✅ Event handling
